...
This guide will help you get the most out of your MONAD server.

---

## Easy Setup Wizard

If this is your first time using MONAD, the Easy Setup wizard will help you get everything configured.
...
**GPU Acceleration:** If your server has an NVIDIA GPU with the [NVIDIA Container Toolkit](https://docs.nvidia.com/datacenter/cloud-native/container-toolkit/latest/install-guide.html) installed, MONAD will automatically use it for AI — dramatically faster responses (10-20x improvement). If you add a GPU later, go to [Apps](/settings/apps) and **Force Reinstall** the AI Assistant to enable it.
...
![System Benchmark with MONAD Score and Builder Tag](/docs/benchmark.webp)
...
You're ready to use MONAD Here are some things to try:
