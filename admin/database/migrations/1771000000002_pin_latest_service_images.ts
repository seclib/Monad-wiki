  ...
  async up() {
    this.defer(async (db) => {
      ...
      const sourceRepos: Record<string, string> = {
        monad_kiwix_server: 'https://github.com/kiwix/kiwix-tools',
        monad_ollama: 'https://github.com/ollama/ollama',
        monad_qdrant: 'https://github.com/qdrant/qdrant',
        monad_cyberchef: 'https://github.com/gchq/CyberChef',
        monad_flatnotes: 'https://github.com/dullage/flatnotes',
        monad_kolibri: 'https://github.com/learningequality/kolibri',
      }
