...
export default class extends BaseSchema {
  ...
  async up() {
    ...
    await this.db.rawQuery(`
      ...
      WHERE service_name = 'monad_kiwix_serve'
    `)
    ...
    await this.db.rawQuery(`
      ...
      WHERE service_name = 'monad_kolibri'
    `)
    ...
    await this.db.rawQuery(`
      ...
      WHERE service_name = 'monad_ollama'
    `)
    ...
    await this.db.rawQuery(`
      ...
      WHERE service_name = 'monad_flatnotes'
    `)
    ...
    await this.db.rawQuery(`
      ...
      WHERE service_name = 'monad_cyberchef'
    `)
  }
