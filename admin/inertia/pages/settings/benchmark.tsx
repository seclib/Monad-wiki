  ...
  useEffect(() => {
    ...
    const stages: {
      ...
      },
      {
        ...
        progress: 95,
        message: 'Calculating MONAD score...',
        ...
        <main className="px-6 lg:px-12 py-6 lg:py-8">
          <div className="mb-8">
            ...
            <p className="text-desert-stone-dark">
              Measure your server's performance and compare with the MONAD community
            </p>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  {showAIRequiredAlert && (
                    <Alert
                      ...
                      message={`Full benchmark requires ${aiAssistantName} to be installed. Install it to measure your complete MONAD capability and share results with the community.`}
                      variant="bordered"
                      dismissible
                ...
                <div className="bg-desert-white rounded-lg p-8 border border-desert-stone-light shadow-sm">
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    <div className="shrink-0">
                      <CircularGauge
                        value={latestResult.monad_score}
                        label="MONAD Score"
                        size="lg"
                        variant="cpu"
                        subtext="out of 100"
                    ...
                    <div className="flex-1 space-y-4">
                      <div
                        className={`text-5xl font-bold ${getScoreColor(latestResult.monad_score)}`}
                      >
                        {latestResult.monad_score.toFixed(1)}
                      </div>
                      <p className="text-desert-stone-dark">
                        Your MONAD Score is a weighted composite of all benchmark results.
                      </p>
                ...
                <div className="bg-desert-white rounded-lg border border-desert-stone-light shadow-sm overflow-hidden">
                  ...
                  >
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-left flex-1">
                      ...
                      <div>
                        <div className="text-desert-stone-dark">MONAD Score</div>
